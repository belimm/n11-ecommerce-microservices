...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DuplicateSlugException.class, CategoryInUseException.class, DataIntegrityViolationException.class})
    public ResponseEntity<ErrorResponse> handleConflict(RuntimeException ex, WebRequest request) {
        return buildResponse(ex, request, HttpStatus.CONFLICT, "Conflict", null);
    }
